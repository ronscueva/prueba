<?php 
  ...
  $lista= mysqli_query($con,"SELECT k.* , p.*  FROM empp_tb_inventario k inner join empp_tb_productos p on p.id_produc = k.id_produc");
...
<div class="modal fade" id="exampleModalCenter" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
                ...
                <table id="example1" class="table table-bordered table-striped">
                  ...
                  <tbody>
                    ...
                    foreach ($lista as $value) {
                      ...
                      <tr>
                    <td><?php echo $cont++; ?></td>
                    <td><?php echo $value['id_produc']; ?></td>
  ...
  <footer class="main-footer">
    ...
    <strong>Copyright &copy; 2023-2023 <a href="https://adminlte.io">AdminLTE.io</a>.</strong> All rights reserved.
  </footer>
