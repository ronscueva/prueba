<?php 
  ...
  $lista= mysqli_query($con,"SELECT id_proveedores,ruc,razon_social,telefono,direccion,fecha_registro,estado FROM empp_tb_proveedores WHERE estado='1'");
            ...
            <div class="card">
              <div class="card-header">
                <h3 class="card-title">Listado de Proveedores Registrados</h3>
                 ...
                 <a style="margin-left: 80px;" class="btn btn-primary"  data-toggle="modal" data-target="#exampleModalCenter"><spam class="glyphicon glyphicon-plus"></spam>Nuevo Proveedor</a>
  ...
  <div class="modal-dialog modal-dialog-centered" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
        <label>Ruc:</label>
        <input type="text" class="form-control" id="rucx"  maxlength="20"  placeholder="Ingrese Nro Ruc...">
        <label>Razon Social:</label>
        <input type="text" class="form-control" id="socialx" placeholder="Ingrese Razon Social...">
        <label>Telefono:</label>
        <input type="text" class="form-control" id="telx"  maxlength="10" placeholder="Ingrese Telefono...">
              ...
              <div class="card-body">
                <table id="example1" class="table table-bordered table-striped">
                  ...
                  <tbody>
                    ...
                    <td><a data-toggle="modal" data-target="#exampleModal" onclick="editarcli(<?php echo $value['id_proveedores']; ?>)" class="btn btn-warning">Editar</a>
                        <a data-toggle="modal" data-target=".bd-example-modal-sm" onclick="eliminarcli(<?php echo $value['id_proveedores']; ?>)" class="btn btn-danger">Eliminar</a></td>
                  </tr>
                    <?php
                  }
                     ?>
