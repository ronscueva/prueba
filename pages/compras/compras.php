    ...
    text-align: left !important;">Datos de Proveedor</legend>
                     ...
                     -webkit-box-shadow:  0px 0px 0px 0px #000;
                             box-shadow:  0px 0px 0px 0px #000;">
                                                    <legend style="font-size: 1.2em !important;
                     font-weight: bold !important;
                     text-align: left !important;">REGISTRO DETALLE DE COMPRAS</legend>
                      <fieldset style=" border: 1px groove #ddd !important;
                     padding: 0 1.4em 1.4em 1.4em !important;
                     margin: 0 0 1.5em 0 !important;
                     -webkit-box-shadow:  0px 0px 0px 0px #000;
                             box-shadow:  0px 0px 0px 0px #000;">
                                                    <legend style="font-size: 1.2em !important;
                     font-weight: bold !important;
                     text-align: left !important;">REGISTRO DEL PRODUCTO MATERIA</legend>
                ...
                <div class="row">
                           ...
                           <div class="col-md-6">
                               ...
                               <input type="text" class="form-control" id="dimensiones"
                                   name="" placeholder="Ingrese las dimensiones...">
                               
                           </div>
                           <div class="col-md-6">
                               <label>Espesor</label>
                               <input type="text" class="form-control" id="espesor"
                                   name="" placeholder="Ingrese el espesor...">
                           ...
                           <div class="col-md-6">
                               ...
                               <input type="text" class="form-control" id="largo"
                                   name="" placeholder="Ingrese el largo...">
                               
                           </div>
                           <div class="col-md-6">
                               <label>Ancho</label>
                               <input type="text" class="form-control" id="ancho"
                                   name="" placeholder="Ingrese el Codigoancho...">
