<?php 
  ...
  $lista= mysqli_query($con,"SELECT p.* , i.id, i.stock , i.fecha_mof from empp_tb_inventario i 
  inner join empp_tb_productos p on  p.id_produc = i.id_produc
  where p.estado = 1");
              ...
              <div class="card-body">
                <table id="example1" class="table table-bordered table-striped">
                  ...
                  <tbody>
                    ...
                    <td><?php echo $value['fecha_mof']; ?></td>
                  </tr>
                    <?php
                  }
                     ?>
