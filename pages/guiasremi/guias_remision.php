                 ...
                 <br>
                  ...
                  <div class="row">
                    <div class="col-md-4">
                      ...
                      <input class="form-control" type="text" id="partida" name="partida" placeholder="Ingrese el Punto de Partida"> 
                    </div>
                    <div class="col-md-4">
                      <label>Punto Llegada:</label>
                      <input class="form-control" type="text" id="llegada" name="llegada" placeholder="Ingrese el Punto de Llegada">
                    </div>
                    <div class="col-md-2">
                      <label>Punto Llegada:</label>
                  ...
                  <div class="row">
                    ...
                    <div class="col-md-2">
                      ...
                      <input type="text" class="form-control" id="pesob" name="pesob" placeholder="Ingresar Peso Bruto">
                    </div>
                  </div>
                  <div class="row">
                    <div class="col-md-7">
