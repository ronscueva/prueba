<?php 
  ...
  $lista= mysqli_query($con,"SELECT a.id_reg,b.n_documento as factura,a.fec_emision,a.transportista,a.peso,a.n_documento as guia FROM empp_tb_guias_cab a
left JOIN empp_tb_factura_cab b on b.id_reg=a.id_factura");
...
<head>
  ...
  <title>AdminLTE 3 | Guias de Remison Emitidas</title>
          ...
          <div class="col-12">
            ...
            <div class="card">
              <div class="card-header">
                <h3 class="card-title">Listado de Cotizaciones Emitidas</h3>
                ...
                <table id="example1" class="table table-bordered table-striped">
                  ...
                  <tbody>
                    ...
                    foreach ($lista as $value) {
                      ...
                      <tr>
                    <td><?php echo $cont++; ?></td>
                    <td><?php echo $value['guia']; ?></td>
                    <td><?php echo $value['factura']; ?></td>
                    <td><?php echo $value['transportista']; ?></td>
