<?php 
  ...
  $lista= mysqli_query($con,"SELECT * FROM empp_tb_productos ");
              ...
              <div class="card-body">
                <table id="example1" class="table table-bordered table-striped">
                  ...
                  <tbody>
                    ...
                    <td><a data-toggle="modal" data-target="#exampleModal" onclick="editarcli(<?php echo $value['id_produc']; ?>)" class="btn btn-warning">Editar</a>
                        <a data-toggle="modal" data-target=".bd-example-modal-sm" onclick="eliminarcli(<?php echo $value['id_produc']; ?>)" class="btn btn-danger">Eliminar</a></td>
                  </tr>
                    <?php
                  }
                     ?>
