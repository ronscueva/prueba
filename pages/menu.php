        ...
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item">
            ...
            <ul class="nav nav-treeview">
              ...
              <li class="nav-item">
                <a href="../proveedores/proveedores.php" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Proveedores</p>
                </a>
              </li>
          ...
          <li class="nav-item">
            ...
            <ul class="nav nav-treeview">
              ...
              <li class="nav-item">
                <a href="../productos/tipo_producto.php" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
          ...
          <li class="nav-item">
            ...
            <ul class="nav nav-treeview">
              <li class="nav-item">
                <a href="../compras/admin_compras.php" class="nav-link ">
                  <i class="far fa-circle nav-icon"></i>
          ...
          <li class="nav-item">
            ...
            <ul class="nav nav-treeview">
              <li class="nav-item">
                <a href="../kardex/kardex.php" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Kardex General</p>
                </a>
              </li>
          ...
          <li class="nav-item">
            <a href="#" class="nav-link">
              ...
              <p>
               ...
               <ul class="nav nav-treeview">
              <li class="nav-item">
                <a href="../guiasremi/guias_remision.php" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Remitir</p>
                </a>
              </li>
              <li class="nav-item">
                <a href="../guiasremi/guias_listado.php" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Guias Emitidas</p>
                </a>
              </li>             
          ...
          <li class="nav-item">
            <a href="#" class="nav-link">
             ...
             <!--  <li class="nav-item">
              ...
              <li class="nav-item">
                <a href="../facturacion/facturas_emitidas.php" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
