<?php 
  ...
  $lista= mysqli_query($con,"SELECT id_reg,n_doc,nombres,estado,direccion,telefono FROM empp_tb_cliente WHERE estado='1'");
...
<head>
  ...
  <title>AdminLTE 3 | Clientes</title>
                ...
                <table id="example1" class="table table-bordered table-striped">
                  ...
                  <tbody>
                    ...
                    foreach ($lista as $value) {
                      ...
                      <tr>
                    <td><?php echo $cont++; ?></td>
                    <td><?php echo $value['n_doc']; ?></td>
                    <td><?php echo $value['nombres']; ?></td>
                    <td><?php echo $value['direccion']; ?></td>
                    <td><?php echo $value['telefono']; ?></td>
                    <td><a data-toggle="modal" data-target="#exampleModal" onclick="editarcli(<?php echo $value['id_reg']; ?>)" class="btn btn-warning">Editar</a>
                        <a data-toggle="modal" data-target=".bd-example-modal-sm" onclick="eliminarcli(<?php echo $value['id_reg']; ?>)" class="btn btn-danger">Eliminar</a></td>
                  </tr>
                    <?php
                  }
                     ?>
