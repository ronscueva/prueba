<?php 
  ...
  $lista= mysqli_query($con,"SELECT * FROM empp_tb_users WHERE status='1'");
                            ...
                            <div class="card">
                                <div class="card-header">
                                    ...
                                    <a style="margin-left: 80px;" class="btn btn-primary" data-toggle="modal"
                                        ...
                                        <spam class="glyphicon glyphicon-plus"></spam>Nuevo Usuario
                                    </a>
                                    <!-- REGISTRO DE CLIENTE -->
                                        ...
                                        <div class="modal-dialog modal-dialog-centered" role="document">
                                            <div class="modal-content">
                                                <div class="modal-header">
                                                    <h5 class="modal-title" id="exampleModalLongTitle">Registrar Usuario
                                                        Nuevo</h5>
                                                ...
                                                <div class="modal-body">
                                                    ...
                                                    <select class="form-control" name="level" id="levelx">
                                                ...
                                                <div class="modal-footer">
                                                    ...
                                                    <button onclick="registrarcli();" type="button"
                      ...
                      ?>
                                            <tr>
                                                ...
                                                <td><a data-toggle="modal" data-target="#exampleModal"
                                                        onclick="editarcli(<?php echo $value['id']; ?>)"
                                                        class="btn btn-warning">Editar</a>
                                                    <a data-toggle="modal" data-target=".bd-example-modal-sm"
                                                        onclick="eliminarcli(<?php echo $value['id']; ?>)"
