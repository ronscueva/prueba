<?php 
  ...
  $lista= mysqli_query($con,"SELECT id_vendedor,dni,nombre_vendedor,apellido_vendedor,estado,direccion,telefono FROM empp_tb_vendedor WHERE estado='1'");
...
<head>
  ...
  <title>AdminLTE 3 | Vendedores</title>
          ...
          <div class="col-12">
            ...
            <div class="card">
              <div class="card-header">
                <h3 class="card-title">Listado de Vendedores Registrados</h3>
  ...
  <div class="modal-dialog modal-dialog-centered" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="exampleModalLongTitle">Registrar Vendedor Nuevo</h5>
      ...
      <div class="modal-footer">
        ...
        <button onclick="registrarven();" type="button" class="btn btn-primary">Grabar</button>
      </div>
    </div>
  </div>
</div>
              ...
              <div class="card-body">
                <table id="example1" class="table table-bordered table-striped">
                  ...
                  <tbody>
                    ...
                    <td><a data-toggle="modal" data-target="#exampleModal" onclick="editarcli(<?php echo $value['id_vendedor']; ?>)" class="btn btn-warning">Editar</a>
                        <a data-toggle="modal" data-target=".bd-example-modal-sm" onclick="eliminarcli(<?php echo $value['id_vendedor']; ?>)" class="btn btn-danger">Eliminar</a></td>
                  </tr>
                    <?php
                  }
                     ?>
                  ...
                  <div class="modal-content">
                    ...
                    <div class="modal-body">
                       <form>
                        ...
                        <label>DNI:</label>
                        <input type="text" class="form-control" placeholder="" id="dnis">
                        <label>Nombre:</label>
                        <input type="text" class="form-control" placeholder="" id="nombres">
                        <label>Apellido:</label>
                        <input type="text" class="form-control" placeholder="" id="apellidos">
                        <label>Telefono:</label>
